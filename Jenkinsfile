...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.90.191:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#nr-cicd-pipeline-alerts', //update and provide your channel name
